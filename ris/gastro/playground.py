from bedrock import collection, viz, common, process, feature
from ris.gastro.risnlp.models.standard import bnb
...
def get_tfidf_data(pickle_path, limit=None):
    ...
    split_level = collection.TEXT_ID
...
def load_default_train_test(granularity_key, split_by_field, limit=None):
    ...
    granularity_field_map = {
        ...
        config.INPUT.impressions: collection.TEXT
    }
...
# Clean bedrock before feeding it to spaCy
punctuations = string.punctuation


# Define function to cleanup bedrock by removing personal pronouns, stopwords, and puncuation
#TODO: add to risnlp
